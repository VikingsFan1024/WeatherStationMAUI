...
#endif
global using ActionBlockOfForecastModel = System.Threading.Tasks.Dataflow.ActionBlock<TempestMonitor.Models.ForecastModel>;
global using ActionBlockOfObject = System.Threading.Tasks.Dataflow.ActionBlock<object>;
global using ActionBlockOfReadingModel = System.Threading.Tasks.Dataflow.ActionBlock<TempestMonitor.Models.ReadingModel?>;
global using BufferBlockOfForecastModel = System.Threading.Tasks.Dataflow.BufferBlock<TempestMonitor.Models.ForecastModel>;
global using BufferBlockOfObject = System.Threading.Tasks.Dataflow.BufferBlock<object>;
global using DictionaryOfStringUnit = System.Collections.Generic.Dictionary<string, RedStar.Amounts.Unit>;
global using ListOfStrings = System.Collections.Generic.List<string>;
global using ListOfTasks = System.Collections.Generic.List<System.Threading.Tasks.Task>;
global using ObservableCollectionOfHourlyObservationSummary = System.Collections.ObjectModel.ObservableCollection<TempestMonitor.ViewModels.History.HourlyObservationSummary>;
...
global using TaskOfNullableJsonDocument = System.Threading.Tasks.Task<System.Text.Json.JsonDocument?>;
...
global using ValueChangedMessageOfAirObservationModel = CommunityToolkit.Mvvm.Messaging.Messages.ValueChangedMessage<TempestMonitor.Models.AirObservationModel>;
global using ValueChangedMessageOfDeviceStatusModel = CommunityToolkit.Mvvm.Messaging.Messages.ValueChangedMessage<TempestMonitor.Models.DeviceStatusModel>;
global using ValueChangedMessageOfForecastModel = CommunityToolkit.Mvvm.Messaging.Messages.ValueChangedMessage<TempestMonitor.Models.ForecastModel>;
global using ValueChangedMessageOfHubStatusModel = CommunityToolkit.Mvvm.Messaging.Messages.ValueChangedMessage<TempestMonitor.Models.HubStatusModel>;
global using ValueChangedMessageOfLightningStrikeModel = CommunityToolkit.Mvvm.Messaging.Messages.ValueChangedMessage<TempestMonitor.Models.LightningStrikeModel>;
global using ValueChangedMessageOfObject = CommunityToolkit.Mvvm.Messaging.Messages.ValueChangedMessage<object>;
global using ValueChangedMessageOfObservationModel = CommunityToolkit.Mvvm.Messaging.Messages.ValueChangedMessage<TempestMonitor.Models.ObservationModel>;
global using ValueChangedMessageOfRainStartModel = CommunityToolkit.Mvvm.Messaging.Messages.ValueChangedMessage<TempestMonitor.Models.RainStartModel>;
global using ValueChangedMessageOfReadingModel = CommunityToolkit.Mvvm.Messaging.Messages.ValueChangedMessage<TempestMonitor.Models.ReadingModel>;
global using ValueChangedMessageOfSkyObservationModel = CommunityToolkit.Mvvm.Messaging.Messages.ValueChangedMessage<TempestMonitor.Models.SkyObservationModel>;
global using ValueChangedMessageOfWindReadingModel = CommunityToolkit.Mvvm.Messaging.Messages.ValueChangedMessage<TempestMonitor.Models.WindReadingModel>;
...
global using AirObservationModel = TempestMonitor.Models.AirObservationModel; // for AirObservationModel
...
global using ApplicationStatisticsModel = TempestMonitor.Models.ApplicationStatisticsModel; // for ApplicationStatisticsModel, used to track statistics on saved records
...
global using CurrentConditionsModel = TempestMonitor.Models.CurrentConditionsModel; // for CurrentConditionsModel
...
global using DailyModel = TempestMonitor.Models.DailyModel; // for DailyModel
global using DatabasePersistenceService = TempestMonitor.Services.DatabasePersistenceService;
global using DatabaseService = TempestMonitor.Services.DatabaseService;
global using DataflowBlock = System.Threading.Tasks.Dataflow.DataflowBlock;
...
global using ForecastModel = TempestMonitor.Models.ForecastModel; // for ForecastModel
...
global using HourlyForecastView1920x1200 = TempestMonitor.Views.HourlyForecastDeviceViews.HourlyForecastView1920x1200; // Default
...
global using HourlyModel = TempestMonitor.Models.HourlyModel; // for HourlyModel
global using HourlyObservationSummary = TempestMonitor.ViewModels.History.HourlyObservationSummary;
global using HttpClient = System.Net.Http.HttpClient;
global using HttpRequestException = System.Net.Http.HttpRequestException;
global using HubStatusModel = TempestMonitor.Models.HubStatusModel; // for HubStatusModel
...
global using ObservableObservation = TempestMonitor.ViewModels.Observables.ObservableObservation;
global using ObservableWindReading = TempestMonitor.ViewModels.Observables.ObservableWindReading;
global using ObservationModel = TempestMonitor.Models.ObservationModel; // for ObservationModel
...
global using PrimaryKey = SQLite.PrimaryKeyAttribute;
...
global using RainStartModel = TempestMonitor.Models.RainStartModel; // for RainStartModel
global using ReadingModel = TempestMonitor.Models.ReadingModel;
...
global using SQLiteConnection = SQLite.SQLiteConnection; // for SQLiteConnection, to avoid ambiguity with System.Data.SQLite
global using SettingsModel = TempestMonitor.Models.SettingsModel;
global using Shell = Microsoft.Maui.Controls.Shell;
global using SkyObservationModel = TempestMonitor.Models.SkyObservationModel; // for SkyObservationModel
...
global using StationModel = TempestMonitor.Models.StationModel; // for StationModel, used in ForecastModel
global using StatusModel = TempestMonitor.Models.StatusModel; // for StatusModel
...
global using TaskCanceledException = System.Threading.Tasks.TaskCanceledException; // for TaskCanceledException in RequestForecasts method
...
global using UnitsModel = TempestMonitor.Models.UnitsModel; // for UnitsModel, used in ForecastModel
...
global using WindReadingModel = TempestMonitor.Models.WindReadingModel; // for WindReadingModel, used in the database persistence service
